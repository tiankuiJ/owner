    ...
    _extend(KUploadButton, {
        init: function (options) {
            ...
            var html = [
                ...
                '</span>',
                '<input type="file" class="ke-upload-file" accept=' + accept + ' name="' + fieldName + '" tabindex="-1" />',
        ...
        edit: function () {
            ...
            var dialog = self.createDialog({
                    ...
                    yesBtn: {
                        ...
                        click: function (e) {
                            ...
                            try {
                                if (videoTarge == true) {
                                    $("#video").attr("src", urlBox.val());
                                    $("#url").val(urlBox.val());
                                } else {
                                    $("#video"+currentTarge).attr("src", urlBox.val());
                                    $("#url"+currentTarge).val(urlBox.val());
                                }
                            } catch (e) {
                                $("#video").attr("src", urlBox.val());
                                $("#url3").val(urlBox.val());
            ...
            if (allowMediaUpload) {
                var uploadbutton = K.uploadbutton({
                    ...
                    accept: 'video/swf,video/flv,video/mp3,video/mp4,video/wav,video/wma,video/wmv,video/mid,video/avi,video/mpg,video/asf,video/rm,video/rmvb',
                    afterUpload: function (data) {
                        dialog.hideLoading();
                        if (data.error === 0) {
                            var url = data.url;
